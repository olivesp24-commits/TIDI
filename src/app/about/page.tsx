      ...
      <section ref={heroRef} className="container mx-auto px-4 md:px-8 max-w-7xl mb-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="max-w-xl">
            ...
            <h1 className="reveal-item opacity-0 font-asul text-5xl md:text-6xl lg:text-7xl font-bold text-brand-navy leading-tight mb-6">
        ...
        <div ref={missionRef} className="container mx-auto px-4 md:px-8 max-w-7xl">
          <div className="grid md:grid-cols-2 gap-12 md:gap-24">
            ...
            <div className="reveal-item opacity-0">
              ...
              <p className="text-brand-lavender-tint/80 text-lg leading-relaxed">
            ...
            <div className="reveal-item opacity-0">
              ...
              <p className="text-brand-lavender-tint/80 text-lg leading-relaxed">
                A world where every individual has equitable access to the knowledge, health, and social support needed to thrive and contribute meaningfully to society. We envision resilient communities built on a foundation of unshakeable human dignity.
              </p>
            </div>
