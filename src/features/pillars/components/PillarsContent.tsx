...
export function PillarsContent({ sanityData }: PillarsContentProps) {
  const heroHeadline = sanityData?.heroHeadline || "The Three Pillars of Impact";
  const heroSubheadline = sanityData?.heroSubheadline || "TIDI operates across three foundational pillars to build resilient communities, break cycles of poverty, and drive sustainable outcomes for the vulnerable.";
    ...
    <div className="bg-brand-offwhite min-h-screen pt-40 md:pt-48 pb-24 overflow-hidden">
      ...
      <section ref={headerRef} className="container mx-auto px-4 md:px-8 max-w-7xl mb-24">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="reveal-item opacity-0 font-asul text-5xl md:text-6xl font-bold text-brand-navy mb-6 whitespace-pre-line">
            {heroHeadline}
          </h1>
          <p className="reveal-item opacity-0 text-xl text-brand-navy/70 leading-relaxed whitespace-pre-line">
            {heroSubheadline}
          </p>
        </div>
      </section>
